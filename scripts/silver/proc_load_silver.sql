        ...
        *,
        ...
        SELECT  
              ...
              SUBSTRING(prd_key, 7, LEN(prd_key)) AS prd_key,        --Extract product key
               ...
               CASE UPPER(TRIM(prd_line))
                    ...
                    WHEN 'T' THEN 'Touring'
               ELSE 'n/a'
               END AS prd_line, -- Map product lines to desciptive value 
        ...
        PRINT 'Inserting data into: silver.crm_sales_details'
          ...
          SELECT 
	            ...
	            ELSE sls_sales
                END sls_sales, --Recalculate sales if original is missing or incorrect
                sls_quantity,
		...
		PRINT '=========================================='
		PRINT 'Loading Siver Layer was Completed';
